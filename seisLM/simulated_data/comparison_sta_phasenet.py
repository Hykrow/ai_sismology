...
STA_CSV   = CSV_DIR/ "metadata_annotated_sta.csv"
PN_CSV    = CSV_DIR / "metadata_annotated_phasenet.csv"
...
def main() -> None:
    ...
    stats_p = compute_stats(merged.loc[mask_p], 'P_pn_s', 'P_sta_s')
    stats_s = compute_stats(merged.loc[mask_s], 'S_pn_s', 'S_sta_s')

    # Affichage des stats
    logging.info("Statistiques pour picks P (score > %0.2f):", 0.3)
    ...
    logging.info("Statistiques pour picks S (score > %0.2f):", 0.3)
