...
class ASTModel(nn.Module):
    ...
    def __init__(self, label_dim=527, fstride=10, tstride=10, input_fdim=128, input_tdim=1024, imagenet_pretrain=True, audioset_pretrain=False, model_size='base384', verbose=True, load_pretrain_patch=120):
        ...
        if audioset_pretrain == False:
            ...
            self.conv1 = nn.Conv2d(in_channels=3, out_channels=1, kernel_size=(5,5), stride=1, padding=(1,2), bias=False)  #ATTENTION Kernel_size changé de(3.5) à (5.5) 
            print("je passe, (5,5)")
            print("conv1 shape after init :", self.conv1.weight.shape)
